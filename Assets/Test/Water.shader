...
Shader "Water"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 temp_cast_1 = (temp_output_25_0).xxxx;
			float2 temp_cast_2 = (4.0).xx;
			float mulTime56 = _Time.y * 0.02;
			float2 temp_cast_3 = (mulTime56).xx;
			float2 uv_TexCoord52 = i.uv_texcoord * temp_cast_2 + temp_cast_3;
			o.Emission = step( temp_cast_1 , tex2D( _Texture1, uv_TexCoord52 ) ).rgb;
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;122;2160,-240;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;101;2320,-720;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;85;2368,-816;Inherit;False;Property;_waveOffset;waveOffset;3;0;Create;True;0;0;0;False;0;False;0.001;0.004;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;84;2576,-848;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;87;2800,-576;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=9F35193FBDAA5A35D9195AD7C30192E78CBF3E2A